                ...
                <div class="contact-grid">
                    <div class="contact-info">
                        ...
                        <div class="social-links">
                            ...
                            <a href="#" class="social-link">
                                <svg viewBox="0 0 24 24" width="24" height="24">
                                    <path d="M7.545 0c-4.151 0-7.545 3.394-7.545 7.545v8.91c0 4.151 3.394 7.545 7.545 7.545h8.91c4.151 0 7.545-3.394 7.545-7.545v-8.91c0-4.151-3.394-7.545-7.545-7.545h-8.91zm0 2.727h8.91c2.671 0 4.818 2.147 4.818 4.818v8.91c0 2.671-2.147 4.818-4.818 4.818h-8.91c-2.671 0-4.818-2.147-4.818-4.818v-8.91c0-2.671 2.147-4.818 4.818-4.818zm10.909 2.727c-.751 0-1.364.613-1.364 1.364s.613 1.364 1.364 1.364 1.364-.613 1.364-1.364-.613-1.364-1.364-1.364zm-6.454 1.364c-3.305 0-6 2.695-6 6s2.695 6 6 6 6-2.695 6-6-2.695-6-6-6zm0 2.727c1.826 0 3.273 1.447 3.273 3.273s-1.447 3.273-3.273 3.273-3.273-1.447-3.273-3.273 1.447-3.273 3.273-3.273z" fill="#4facfe"/>
                                </svg>
                            </a>
                            <a href="#" class="social-link">
                                <svg viewBox="0 0 24 24" width="24" height="24">
